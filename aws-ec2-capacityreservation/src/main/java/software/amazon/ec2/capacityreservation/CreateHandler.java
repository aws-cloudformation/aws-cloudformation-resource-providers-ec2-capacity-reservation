                ...
                .then(progress ->
                        ...
                        proxy.initiate("AWS-EC2-CapacityReservation::Create", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
                                ...
                                .stabilize((createCapacityReservationRequest, createCapacityReservationResponse, client, model, context) -> {
                                    ...
                                    logger.log(String.format("CR is in %s state ", createCapacityReservationResponse.capacityReservation().state().toString()));
                                ...
                                .handleError((createCapacityReservationRequest, exception, ec2client, model, context) -> ProgressEvent.defaultFailureHandler(exception, HandlerErrorCode.GeneralServiceException))
                                .progress())
